...
'平台详情':'Detalles de la plataforma','左侧：平台详情':'Izquierda: Detalles','平台介绍':'Introducción','评分':'Puntuación','左侧：平台详情':'Izquierda: Detalles','用户评分':'Puntuación de usuario','评分分布':'Distribución',
...
'平台详情':'Détails de la plateforme','左侧：平台详情':'Gauche: Détails','平台介绍':'Introduction','评分':'Note','左侧：平台详情':'Gauche: Détails','用户评分':'Note utilisateur','评分分布':'Distribution',
...
'平台详情':'Plattformdetails','左侧：平台详情':'Links: Details','平台介绍':'Einführung','评分':'Bewertung','左侧：平台详情':'Links: Details','用户评分':'Benutzerbewertung','评分分布':'Verteilung',
...
'平台详情':'Детали платформы','左侧：平台详情':'Слева: Детали','平台介绍':'Описание','评分':'Рейтинг','左侧：平台详情':'Слева: Детали','用户评分':'Оценка пользователей','评分分布':'Распределение',
...
'平台详情':'تفاصيل المنصة','左侧：平台详情':'اليسار: التفاصيل','平台介绍':'المقدمة','评分':'التقييم','左侧：平台详情':'اليسار: التفاصيل','用户评分':'تقييم المستخدم','评分分布':'التوزيع',
...
'平台详情':'Chi tiết nền tảng','左侧：平台详情':'Trái: Chi tiết','平台介绍':'Giới thiệu','评分':'Đánh giá','左侧：平台详情':'Trái: Chi tiết','用户评分':'Đánh giá người dùng','评分分布':'Phân bố',
...
'平台详情':'รายละเอียดแพลตฟอร์ม','左侧：平台详情':'ซ้าย: รายละเอียด','平台介绍':'แนะนำ','评分':'คะแนน','左侧：平台详情':'ซ้าย: รายละเอียด','用户评分':'คะแนนผู้ใช้','评分分布':'การกระจาย',
...
'平台详情':'Detail Platform','左侧：平台详情':'Kiri: Detail','平台介绍':'Pengantar','评分':'Rating','左侧：平台详情':'Kiri: Detail','用户评分':'Rating Pengguna','评分分布':'Distribusi',
...
'全球最全的AI Token导航平台':'Navigator AI Token paling komprehensif di dunia',
'平台详情':'Butiran Platform','左侧：平台详情':'Kiri: Butiran','平台介绍':'Pengenalan','评分':'Penilaian','左侧：平台详情':'Kiri: Butiran','用户评分':'Penilaian Pengguna','评分分布':'Pengedaran',
'5星':'5 Bintang','4星':'4 Bintang','3星':'3 Bintang','2星':'2 Bintang','1星':'1 Bintang',
...
'平台详情':'Detalye ng Platform','左侧：平台详情':'Kaliwa: Detalye','平台介绍':'Panimula','评分':'Rating','用户评分':'Rating ng User','评分分布':'Distribusyon',
